...
<div class="container"> 
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="bookName" name="nazev_knihy" aria-describedby="emailHelp" placeholder="Proměny">
    </div>
    <div class="form-group">
        <label for="exampleInputPassword1">Název Autora</label>
        <input type="text" class="form-control" id="authorName" name="autor" placeholder="Publius Ovidius Naso">
    </div>
    <div class="form-group">
        <label for="exampleInputPassword1">Přebal</label>
        <input type="text" class="form-control" id="cover" name="prebal" placeholder="https://www.databazeknih.cz/img/books/13_/13323/bmid_promeny-Rrz-13323.jpg">
    </div>
    <div class="form-group">   
